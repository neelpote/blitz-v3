      ...
      <div className="bg-white border-b border-stone-100 pt-24 pb-10">
        <div className="container mx-auto px-6">
          ...
          <div className="flex gap-10 mt-8 flex-wrap">
            ...
            <StatBox label="Total Ask" value={totalAsk > 0 ? `${totalAsk} SOL` : '—'} />
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-6 flex-wrap">
                  <div><div className="font-serif text-2xl" style={{ color: GOLD }}>{voteCounts[topRound.roundId.toNumber()] || 0}</div><div className="text-xs text-stone-500 uppercase tracking-widest">Votes</div></div>
                  {topMeta?.askAmount && <div><div className="font-serif text-2xl" style={{ color: GOLD }}>{topMeta.askAmount} SOL</div><div className="text-xs text-stone-500 uppercase tracking-widest">Asking</div></div>}
                  {topMeta?.gitRepo && <a href={topMeta.gitRepo} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-xs font-bold uppercase tracking-widest mt-1 hover:underline" style={{ color: GOLD }}>View Repo →</a>}
                </div>
              </div>
            </div>
          </div>
                      ...
                      <div className="space-y-2 mb-4 flex-1">
                        ...
                        {meta?.askAmount && (
                          <div className="flex justify-between border-b border-stone-100 pb-2">
                            ...
                            <span className="text-stone-700 text-xs font-bold">{meta.askAmount} SOL</span>
                          </div>
                        )}
                        {meta?.walletAddress && (
                          <div className="flex justify-between border-b border-stone-100 pb-2">
                        ...
                        <div className="flex justify-between border-b border-stone-100 pb-2">
                          ...
                          <span className="text-xs font-bold" style={{ color: GOLD }}>{votes}</span>
                        </div>
                        <div className="flex justify-between border-b border-stone-100 pb-2">
                          <span className="text-stone-400 text-xs uppercase font-bold tracking-wider">Winner</span>
                          <span className="text-stone-700 text-xs font-bold">{winner ? winner.slice(0, 6) + '...' + winner.slice(-4) : 'Pending'}</span>
                        </div>
                      </div>
                      {alreadyVoted ? (
